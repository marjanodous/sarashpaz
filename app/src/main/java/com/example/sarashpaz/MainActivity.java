...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for go to daste bandi
        dastebandi=findViewById(R.id.txt_dastebandi);
        dastebandi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, com.example.sarashpaz.dastebandi.class));
            }
        });
